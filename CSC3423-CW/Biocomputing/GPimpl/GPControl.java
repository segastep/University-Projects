...
import Biocomputing.ClassifierAggregated;
import Biocomputing.InstanceSet;
import Biocomputing.NNimpl.NNClassifier;
import Biocomputing.Rand;
...
public class GPControl {
    ...
    public static Classifier generateSubsolution(InstanceSet trainingSet) {
        ...
        GPClassifier classifier = new GPClassifier(trainingSet);
